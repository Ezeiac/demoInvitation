...
export const DressCodeHe = ({
    ...
    return (
        <div id="dresscodeHe" className='content-center w-full align-self-center '>
            <div id="selectorHe" className="absolute w-1/2 lg:w-1/5 right-[32px] lg:right-1/4 top-1/4 border z-60 bg-[#00000090] opacity-0 invisible">
            ...
            <div id="showcase" className="w-full h-full lg:h-auto flex justify-start"
            >
                <div id="maniquiHe" className="h-full w-full lg:w-1/2 relative content-center max-w-500 lg:h-1/2"
